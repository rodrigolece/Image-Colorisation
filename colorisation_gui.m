...
handles.image = imread('asterix.jpg'); % Load a picture and store it
...
handles.grey = convert2greyscale(handles.image);
axes(handles.axes1); 
imshow(handles.grey);
...
fake = fakeImage(handles.image, npixels, 1); % Currently using seed 1
handles.grey = fake;
